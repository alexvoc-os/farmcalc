...
// Funcția va fi reactivată după ce coloana an_agricol va fi adăugată în database
export async function migreazaCulturiLaAnAgricol(): Promise<{ success: boolean; count: number }> {
  console.log('⚠️ Migrare automată dezactivată - rulează scriptul SQL manual în Supabase Dashboard');
